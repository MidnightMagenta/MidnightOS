...
static inline void store_idt(struct desc_ptr *ptr) { __asm__ volatile("lidt %0" : "=m"(*ptr)::"memory"); }
static inline void store_gdt(struct desc_ptr *ptr) { __asm__ volatile("lgdt %0" : "=m"(*ptr)::"memory"); }
